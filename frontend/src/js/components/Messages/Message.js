            ...
            <HomeContext.Consumer>
                {(value) => {
                    ...
                    return (
                        <div>
                            {name &&
                                <Comment style={(!adminActivePage && signedInUser.account_id == message.sender_id) || (adminActivePage && adminActivePage.account_id == message.sender_id) ? meMessageStyle : otherMessageStyle}>
